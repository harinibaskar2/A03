...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        for (int i = 0; i < numLocalWorkers; i++) {
            localWorkers[i] = new Thread(
                new LocalWorker(repository, i + 1),
                "LocalWorker-" + (i + 1)
            );
        ...
        Outsourcer outsourcer = new Outsourcer(broker, "Outsourcer");  
